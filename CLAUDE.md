...
- `user-manual-install-zsh-plugins.sh` — clone zsh-autosuggestions / zsh-syntax-highlighting / zsh-completions / fzf-tab (the last from Aloxaf, not zsh-users) into `~/.config/zsh/plugins/`. No sudo. --dry-run / --no-prompt.
